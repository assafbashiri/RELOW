...
class SEARCHScreen(Screen):
    ...
    def search_by_name(self):
        ...
        # bad search
        if len(ans) == 0:
            self.lab.text = "We are sorry, we cant find offers for you by this name.."
    ...
    def search_by_company(self):
        ...
        # bad search
        if len(ans) == 0:
            self.lab.text = "We are sorry, we cant find offers for you by this company.."
            if "lab" not in self.ids.main_search.ids.search_box.ids.extra.ids:
                self.ids.main_search.ids.search_box.ids.extra.add_widget(self.lab)
                self.ids.main_search.ids.search_box.ids.extra.ids["lab"] = self.lab
            # good search
    ...
    def search_by_price(self):
        ...
        # bad search
        if len(ans) == 0:
            self.lab.text = "   We are sorry, there is no offers in this price.."
            if "lab" not in self.ids.main_search.ids.search_box.ids.extra.ids:
                self.ids.main_search.ids.search_box.ids.extra.add_widget(self.lab)
                self.ids.main_search.ids.search_box.ids.extra.ids["lab"] = self.lab
    ...
    def search_by_end_date(self):
        ...
        # bad search
        if len(ans) == 0:
            self.lab.text = "   We are sorry, there are no offers that ends before this date.."
            if "lab" not in self.ids.main_search.ids.search_box.ids.extra.ids:
                self.ids.main_search.ids.search_box.ids.extra.add_widget(self.lab)
                self.ids.main_search.ids.search_box.ids.extra.ids["lab"] = self.lab
