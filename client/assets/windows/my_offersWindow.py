...
class MY_OFFERS_Screen(Screen):
    ...
    def show_history_purchases(self):
        self.ids.offers_box.ids.offi.remove_widget(self.lab)
        self.ids.offers_box.ids.offi.remove_widget(self.of)
