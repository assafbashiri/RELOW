from assets.Service.Object.ProductService import ProductService
from assets.Service.Object.PurchaseService import PurchaseService
...
class OfferService:
    ...
    def __init__(self, offer_id, user_id, product, category_id, sub_category_id, status, steps, start_date, end_date,
        ...
        for buyer in current_buyers:
            self.current_buyers[buyer['buyer_id']] = PurchaseService(buyer['buyer_id'], buyer['step_id'], buyer['quantity'], buyer['color'], buyer['size'], buyer['address'])
