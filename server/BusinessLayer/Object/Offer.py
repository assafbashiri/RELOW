...
class Offer:
    ...
    def __init__(self, next_id, user_id, product, category_id,
                 sub_category_id, status, steps, start_date, end_date, current_buyers,
                 total_product, hot_deals, confirm):#,category_name,sub_category_name):
