class UsersDAO:
    ...
    def insert(self, userDTO):
        ...
        self._conn.execute(
            """INSERT INTO users_submission (user_id, first_name, last_name, user_name, email, password, birth_date, gender, is_logged, active) VALUES (?,?,?,?,?,?,?,?,?,?)""",
                           [userDTO.user_id, userDTO.first_name, userDTO.last_name, userDTO.user_name, userDTO.email, userDTO.password, userDTO.birth_date, userDTO.gender, True, True])
        self._conn.commit()
        ...
        self._conn.execute(
            ...
            [userDTO.user_id, userDTO.credit_card_number, userDTO.credit_card_experation_date, userDTO.cvv, userDTO.card_type, userDTO.id_number])
        self._conn.commit()
    ...
    def add_address(self, user_id, city, street, zip_code, floor, apartmentNumber):
        ...
        self.updateApartmentNumber(user_id,apartmentNumber)
        #self._conn.execute(
            #"""INSERT INTO users_address (user_id, city, street, zip_code, floor, apt) VALUES (?,?,?,?,?,?)""",
